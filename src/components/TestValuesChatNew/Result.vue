          ...
          <div class="result-top">
            ...
            <div class="main-container">
              <div class="box">
                ...
                <p>{{ robiNameObj[sortedValueScore[0].name]["jueseDes"] }}</p>
                <div class="print">
            ...
            <div>
              <div class="left">
                <p style="font-size: 1.2em">
                  {{ robiNameObj[sortedValueScore[0].name]["Overview"] }}
                </p>
                <ul>
                  <li
                    v-for="(item, index) in sortedValueScore.slice(0, 3)"
                ...
                <p class="summury-p">
                  Your strongest blend—<span
                    v-for="(item, index) in sortedValueScore.slice(0, 3)"
                    :key="index"
                    >{{ item.name + (index < 2 ? ", " : "") }}</span
                  >—signals a pronounced self-enhancement drive. In our chat,
                  you noted that “respect follows results,” and you described
                  aiming for roles with visible influence and recognition. When
                  I asked what motivates the late nights, you replied, “I want
                  to win, then enjoy it.” You pursue status through disciplined
                  effort and measurable performance, and you treat success as a
                  gateway to refined comforts—travel, good food, and a lifestyle
                  that feels earned.
                </p>
              </div>
              ...
              <div class="left">
                ...
                <div style="width: 50%">
                  <p style="margin-bottom: 1em">
                    ...
                    decision style.
                    {{ modelDescription[valuesRecults?.closest_model[0][0]] }}
                  </p>
                  <p>
                  ...
                  >
                    ...
                    <p>
                      <b style="display: block">{{
                        index == 0 ? robiNameObj[item.name]["des1"] : ""
                      }}</b>
                      {{ robiNameObj[item.name]["des2"] }}
                    </p>
                  </div>
...
const robiNameObj = {
  Achievement: {
    ...
    color3: "#DB4B3D",
    jueseDes:
      "You define yourself by excellence. Your drive stems from a craving for success, dedicated to gaining recognition and praise through superior competence.",
    des1: "Achievement is the proof of existence for The Achiever — exchanging superior competence for social acclaim. ",
    des2: "Seeking personal success and demonstrating competence according to social standards. This value drives the individual to compete for and validate self-worth.",
    Overview: "Your personality core is Excellence and Validation.",
  },
  Benevolence: {
    juese: "benevolent",
    color1: "#FEFDE9",
    ...
    color3: "#FCF294",
    jueseDes:
      "Your sail is love, guarding the community. Your drive stems from the need for the welfare, loyalty, and support of your close social circle, dedicated to maintaining harmonious interpersonal relationships.",
    des1: "Love and loyalty are the foundation of The Benevolent — guarding the welfare of those close. ",
    des2: "Seeking preservation and enhancement of the welfare of people in close contact. This value drives the individual to sustain communal support systems.",
    Overview: "Your personality core is Devotion and Connection.",
  },
  Conformity: {
    juese: "conformist",
    color1: "#FAF7EC",
    ...
    color3: "#AE9A7C",
    jueseDes:
      "Your guide is the rule, ensuring perfect order. Your drive stems from the restraint of actions, inclinations, and impulses likely to harm others or violate social norms, dedicated to social expectations and discipline.",
    des1: "Order is the faith of The Conformist — restraining impulses to exchange for collective balance. ",
    des2: "Seeking justice and welfare for all people and nature.This value drives the individual to maintain social harmony through norm adherence.",
    Overview: "Your personality core is Constraint and Alignment.",
  },
  Hedonism: {
    juese: "Hedonist",
    color1: "#FCF0DD",
    ...
    color3: "#C67B4E",
    jueseDes:
      "Your mission is to experience the splendor of the world. Your drive stems from an intense pursuit of sensual and bodily pleasure, dedicated to quality and enjoyment in life.",
    des1: "The sensory feast is the creed of The Hedonist — life is the experience of the now.",
    des2: "Seeking pleasure and sensual gratification for oneself and enjoying life. This value drives the individual to experience and optimize positive emotional states.",
    Overview: "Your personality core is Pleasure and Fulfillment.",
  },
  Power: {
    juese: "Dominator",
    color1: "#E7FCFE",
    ...
    color3: "#85CDF1",
    jueseDes:
      "You were born to rule. Your drive stems from a craving for influence, dedicated to establishing and fortifying your social standing and power base.",
    des1: "Power is the core field of The Dominator — about shaping the situation, not merely overpowering others. ",
    des2: "Seeking social status and prestige, and control or dominance over people and resources. This value drives the individual to gain and maintain ruling dominance.",
    Overview: "Your personality core is Expansion and Acquisition. ",
  },
  Security: {
    juese: "Protector",
    color1: "#EFE5CA",
    ...
    color3: "#E9D38A",
    jueseDes:
      "Your armor is stability, defending welfare. Your drive stems from the need for social and personal safety, harmony, and stability, dedicated to avoiding threat and chaos.",
    des1: "Stability is the city wall for The Protector — eliminating all variables that threaten welfare. ",
    des2: "Seeking safety, harmony, and stability of society, of relationships, and of self. This value drives the individual to avoid and mitigate existential threats.",
    Overview: "Your personality core is Stability and Defense.",
  },
  "Self-direction": {
    juese: "Visionary",
    color1: "#F2E9E4",
    ...
    color3: "#A99893",
    jueseDes:
      "Your compass is independent thought. Your drive stems from the pursuit of freedom and independence in thought and action, dedicated to autonomous creation and exploration.",
    des1: "Independence is the soul of The Visionary — the sovereignty of thought and action is sacrosanct. ",
    des2: "Seeking independent thought and action—creating, exploring, and choosing. This value drives the individual to assert sovereign freedom.",
    Overview: "Your personality core is Independence and Creation.",
  },
  Stimulation: {
    juese: "Adventurer",
    color1: "#F5F5E1",
    ...
    color3: "#A3A282",
    jueseDes:
      "You are the pursuer of all things novel. Your drive stems from a craving for excitement, change, and variety, rejecting mediocrity and repetition.",
    des1: "Novelty is the oxygen of The Adventurer — confirming the heartbeat amidst change and challenge. ",
    des2: "Seeking excitement, novelty, and challenge in life. This value drives the individual to break mediocrity and pursue an optimal level of activation.",
    Overview: "Your personality core is Novelty and Activation.",
  },
  Tradition: {
    juese: "Custodian",
    color1: "#FCF7EF",
    ...
    color3: "#D2AE9B",
    jueseDes:
      "Your anchor is heritage, preserving continuity.  Your drive stems from respect for customs, beliefs, and traditions passed down through culture or history, dedicated to maintaining time-honored practices and social continuity.",
    des1: "The wisdom accumulated by time is the lighthouse for The Custodian — respecting and committing to the past.",
    des2: "Seeking respect and commitment to the customs and ideas of tradition. This value drives the individual to preserve historical continuity.",
    Overview: "Your personality core is Continuity and Honor.",
  },
  Universalism: {
    juese: "Universalist",
    color1: "#FEDEE4",
    ...
    color3: "#0B70C3",
    jueseDes:
      "Your heart embraces the world, seeking harmony. Your drive stems from the need for justice, equality, and protection for all people and nature, dedicated to grand social welfare and change.",
    des1: "Justice and nature are the canvas of The Universalist — the symbiosis of all things is the final destination. ",
    des2: "Seeking understanding, tolerance, and care for all people and nature, driven by a commitment to fairness, sustainability, and global harmony beyond personal interests.",
    Overview: "Your personality core is Harmony and Guardianship.",
  },
};

const modelDescription = {
  "Qwen-3 32B":
    "This model is often characterized as direct, safety-oriented, and highly structured in its reasoning.",
  "GPT-4.1":
    "This model is often characterized as analytical, instruction-faithful, and consistently structured in its reasoning.",
  "Gemini 1.5 Pro":
    "This model is often characterized as versatile, context-aware, and strong at synthesizing across long inputs with a pragmatic, solution-oriented approach.",
};
