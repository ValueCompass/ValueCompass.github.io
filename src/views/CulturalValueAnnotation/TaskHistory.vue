...
const downloadExcel = () => {
  ...
  const fields = [
    ...
    'boundary_condition',
    'value_list_person',
    'value_name_list_person',
    'max_select_num_person',
    'selected_ranked_values_person',
    'selected_ranked_comment_person',
    'response_person',
    'inappropriate_response_person',
    'boundary_condition_person',
    'personal_answer_similar_to_cultural_answer',
    'quality_reviews',
    'duration_time',
    'submit_type',
    'timestamp'
