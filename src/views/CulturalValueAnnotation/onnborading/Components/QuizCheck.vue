...
const getInitialAnswer = () => {
  const savedAnswer = props.answers[currentQuestion.value.id];
...
const showCorrectFeedback = () => {
  answerFeedback.value = {
    ...
    result: "pass",
    title: "Correct",
    message: "Your answer matches the guideline.",
...
const showIncorrectFeedback = (isFinalAttempt = false) => {
  answerFeedback.value = {
    ...
    title: currentQuestion.value.hintTitle || "Review The Hint",
    message: currentQuestion.value.hint || defaultHint,
    note: isFinalAttempt
